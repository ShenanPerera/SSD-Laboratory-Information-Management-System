...
const UpdateTestForm = ({ Test }) => {
  ...
  const handleUpdate = async (e) => {
    ...
    const test = {
      testID: DOMPurify.sanitize(testID),
      testName: DOMPurify.sanitize(testName),
      outsourced: DOMPurify.sanitize(outsourced),
      shortName: DOMPurify.sanitize(shortName),
      specimen: DOMPurify.sanitize(specimen),
      price: DOMPurify.sanitize(price),
      heading: DOMPurify.sanitize(heading),
      remarks: DOMPurify.sanitize(remarks),
    };
